					...
					<div class="p-r-50 p-r-0-lg">
						<div class="p-b-40">
							<div class="blog-detail-img wrap-pic-w">
								<img src="dashboard/news/<?php echo $row['nimage']; ?>" height=600 width=600 alt="News">
							</div>
							...
							<div class="blog-detail-txt p-t-33">
								...
								<div class="s-text8 flex-w flex-m p-b-21">
									...
									<span>
										<?php
							$result = mysqli_query($conn,"SELECT * FROM comments where news_id = $news_id");
...
<?php 		
							...
							$result= mysqli_query($conn,"SELECT * FROM comments where news_id = $news_id") or die (mysql_error());
							$row=mysqli_num_rows($result);
							$ctr=1;
							while ($row= mysqli_fetch_array ($result) ){
						...
						<form method="POST" enctype="multipart/form-data">
							...
							<div class="w-size24">
								<!-- Button -->
								<button class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4" <?php echo $row['news_id']; ?>>
									Post Comment
								</button>
							</div>
						</form><?php } ?>
...
$result=mysqli_query($conn,"select * from comments WHERE comment='$comment' ") or die (mySQL_error());
			...
			mysqli_query($conn,"insert into comments (name,email,comment,news_id,commentto,commentdate) values ('$name', '$email', '$comment','$news_id','$nname','$cur_date')")or die(mysql_error());
...
<br>
						...
						<ul class="bgwhite">
							<li class="flex-w p-b-20">
								<a href="newsdetail.php<?php echo '?news_id='.$news_id; ?>" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
									<img src="dashboard/news/<?php echo $row['nimage']; ?>" width=150 height= 100 alt="IMG-PRODUCT">
								</a>
