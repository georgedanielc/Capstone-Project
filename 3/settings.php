				...
				<div class="col-md-4 col-lg-3 p-b-75">
					<div class="rightbar">
						...
						<form method = "POST" >
							...
							<input class="sizefull s-text7 p-l-22 p-r-22" type="password" name="password"  placeholder="User Name">
						</div>
						...
						<br>
								...
								<br><br>
							<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="password" name="password1" required class="form-control" id="password1" placeholder=" Enter New Password">   
						</div>
							<br>
									<label for="password2">Retype Password</label>
								<br><br>
							<div class="bo4 of-hidden size15 m-b-20">
							<input class="sizefull s-text7 p-l-22 p-r-22" type="password" name="password2"   required class="form-control" id="password2" placeholder="Retype New Password">   
