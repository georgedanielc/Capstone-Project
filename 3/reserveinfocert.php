...
<?php endif;?>
	...
	<!-- content page -->
		<section class="bgwhite p-t-66 p-b-38">
				...
				$result= mysqli_query($conn,"select * from certificates where cert_id='$cert_id'") or die (mysql_error());
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <!-- /.modal --> 
				...
				<button class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4"<?php echo '?cert_id='.$cert_id; ?>> 
						Send Request
					</button>
								<?php else:?>
...
$purpose= $_POST['purpose'];
	...
	$result=mysqli_query($conn,"select * from document_request where cert_id='$cert_id' and username='$username'") or die (mySQL_error());
					$row=mysqli_num_rows($result);
...
$uimage=$row['uimage'];
		   ...
		   $result= mysqli_query($conn,"select * from certificates where cert_id='$cert_id'") or die (mysql_error());
			...
			$cur_date = date("Y-m-d H:i:s");
				...
				$sql="INSERT INTO document_request(cert_id,iname,purpose,stats,datereserved,type,username,contact,address,uimage,fname,mname,lname)
			VALUES('$cert_id','$iname','$purpose','Pending','$cur_date','document','$username','$contact','$address','$uimage','$fname','$mname','$lname')";
