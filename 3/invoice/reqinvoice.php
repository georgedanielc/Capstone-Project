              ...
              <div class="invoice-body">
				...
				while ($row= mysqli_fetch_array ($result) ){
                  ...
                  <div class="col-md-9">
                    ...
                    <address>
                  <strong>Mahabang Parang Resident</strong><br>
                  ...
                  <div class="col-md-3">
                    <br>
                    <div>
                      <div class="pull-left"> Acknowledgement SLIP NO : </div>
                      <div class="pull-right"> <?php echo $row['request_id']; ?> </div>
                      <div class="clearfix"></div>
                    </div>
                    <div>
                      <!-- /col-md-3 -->
                      <div class="pull-left"> Acknowledgement SLIP DATE : </div>
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      <th class="text-left"><?php echo $row['request_id']; ?></td>
                    ...
                    <tr>
                      <td colspan="2" rowspan="4">
                        ...
                        <p>Thank you for your using our services. We do expect you to come at the barangay 3 working days before your requested date, so please process this slip within that time. </p>
