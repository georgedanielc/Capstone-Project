...
<body>
    <div id="wrapper">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li><a href="request.php"><i class="fa fa-tasks"></i> Pending Requests</a></li>                    
						...
						<li class="active"><a href="message.php"><i class="fa fa-globe"></i> Message</a></li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Messages</small></h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Guest Message</h3>
                        </div>
                        <div class="panel-body">
                            <div id="shieldui-grid1">
								      ...
								      <div class="button-print">
									    <a href="reports/messagereport.php" target="_blank">
...
<table>
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from messages where msg_id LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
else{
		
											$result= mysqli_query($conn,"select * from messages order by fullname ASC ") or die (mysql_error());
  ...
  <tr>
	...
	<td>
	 ...
	 <a href="deletemessage.php<?php echo '?msg_id='.$msg_id; ?>"><button type="button" class="btn btn-primary btn-sm">Delete</button></a>
	 <a href="viewmessage.php<?php echo '?msg_id='.$msg_id; ?>"><button type="button" class="btn btn-primary btn-sm">View Message</button></a>
	</td>
  </tr>
  		<?php } ?>
</table>
