...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Registered Users</small></h1>
...
<table>
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from users where username LIKE '%$txtsearch%'") or die (mysql_error());
  ...
  <tr>
	...
	<td>
	 ...
	 <a href="deleteuser.php<?php echo '?username='.$username; ?>"><button type="button" class="btn btn-primary btn-sm">Delete</button></a>

	 <a href="edituser.php<?php echo '?username='.$username; ?>"><button type="button" class="btn btn-primary btn-sm">Edit</button></a>
	</td>
  </tr>
  		<?php } ?>
</table>
