                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div id="shieldui-grid1">
								  ...
								  <a href="adduser.php"><button type="button" class="btn btn-primary">Add Resident </button></a>
...
<table>
  <tr>
	...
	<th>gender</th>	
	 ...
	 <th>precint_no</th>	
	 <th>blood_type</th>
	<th>highest_educational_attainment</th>
	<th>house_ownership_status</th>
	<th>land_ownership_status</th>
	<th>dwelling_type</th>
	<th>former_address</th>
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-products'];
								$result= mysqli_query($conn,"select * from resident where resident_id LIKE '%$txtsearch%' or bname LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
	else{
		
											$result= mysqli_query($conn,"select * from resident order by lname ASC ") or die (mysql_error());
