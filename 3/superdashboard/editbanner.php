...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                                        <h1>Barangay Mahabang Parang <small>Home Banners</small></h1>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<div class="picture">
							   ...
							   <a href=""><?php if($row['bimage'] != ""): ?>
										<img src="banners/<?php echo $row['bimage']; ?>" width="200px" height="150px" style="border:4px groove #CCCCCC; border-radius:5px;">
										<?php else: ?>
										<img src="images/book_image.jpg" width="100px" height="100px" style="border:4px groove #CCCCCC; border-radius:5px;">
										<?php endif; ?>
										</a>	
                                    <input type="file" style="height:44px; margin-top:10px;" name="image" id="last-name2" value=<?php echo $row['bimage']; ?>/>
							...
							<div class="products-add-info">
									...
									<label class="control-label .col-lg-2" for="first-name">Name
							         ...
							         <input type="text" name="bname" class="form-control"  placeholder="Enter Name" value="<?php echo $row['bname']; ?>">
								    </div>
									</div>
							...
							<?php } ?>
						            ...
						            <div class="btn-addproducts">
									 <a href="banner.php"> <button type="button" class="btn btn-primary">Cancel</button></a>
									</div>
...
mysqli_query($conn,"update banner set bname='$bname', bimage='$still_profile1' where b_id='$b_id'")or die(mysql_error());
echo "<script>alert('Successfully Updated Info!'); window.location='banners.php'</script>";		
...
move_uploaded_file($_FILES["image"]["tmp_name"],"banners/" . $_FILES["image"]["name"]);			
$profile=$_FILES["image"]["name"];								
$bname = $_POST['bname'];
								
								
mysqli_query($conn,"update banner set bname='$bname', bimage='$profile' where b_id='$b_id'")or die(mysql_error());								
echo "<script>alert('Successfully Updated Info!'); window.location='banners.php'</script>";										
									}
