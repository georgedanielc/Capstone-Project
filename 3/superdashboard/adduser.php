...
<li><a href="admin.php"><i class="fa fa-bullseye"></i>Admin Information</a></li>
	...
	<?php
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Resident Information</small></h1>
...
$email = $_POST['email'];
					...
					{		
						...
						values ('$username','$fname','$mname', '$lname', '$password', '$address', '$contact','$email','Resident','$book_image')";
						if ($conn->query($sql) === TRUE) {
                   		echo "<script>alert('User successfully added!'); window.location='users.php'</script>";
                        } else {
							echo "<script>alert('iuhjkhj'); window.location='Admin.php'</script>";
                        }
