            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li><a href="users.php"><i class="fa fa-bullseye"></i>Resident Users</a></li>
						<li  class="active"><a href="admin.php"><i class="fa fa-bullseye"></i>Admin Information</a></li>
...
<ul class="nav navbar-nav navbar-right navbar-user">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Administrator information</small></h1>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div id="shieldui-grid1">
								  ...
								  <a href="addadmin.php"><button type="button" class="btn btn-primary">Add Admin </button></a>
								  
								  </div>
								  
								  								      <div class="button-print">
									    <a href="reports/adminreport.php" target="_blank">
								...
								<form method="POST">
                                 ...
                                 <span class="input-group-btn"  id="margin-timing">
...
<table>
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from user where username LIKE '%$txtsearch%' or lname LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
	else{
		
											$result= mysqli_query($conn,"select * from users where position='Admin'") or die (mysql_error());
  ...
  <tr>
    <td><img src="pimage/<?php echo $row['uimage']; ?>" width="75px" height="50px"></td>
	...
	<td>
	 <a href="edituser.php<?php echo '?username='.$username."".'&'.'user='.'admin'; ?>"><button type="button"  class="btn btn-primary btn-sm">Edit</button></a>
	 
	 <?php if($username==3): ?>
	 
	 <?php else: ?>
	 	 <a href="deleteadmin.php<?php echo '?username='.$username."".'&'.'user='.'admin'; ?>"><button type="button" class="btn btn-primary btn-sm">Delete</button></a>
	 <?php endif; ?>
