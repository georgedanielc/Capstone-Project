            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li><a href="request.php"><i class="fa fa-tasks"></i> Pending Requests</a></li>                    
						...
						<li class="active"><a href="banners.php"><i class="fa fa-bullseye"></i>Banners</a></li>
						<li style=" margin-left: 10px;"><p style="color:gray; cursor:context-menu;">____________________________</p></li>
...
<div class="button-addproducts">
								  ...
								  <a href="addbanner.php"><button type="button" class="btn btn-primary">Add Banner </button></a>
...
<table>
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from banner where b_id LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
else{
		
											$result= mysqli_query($conn,"select * from banner order by b_id ASC ") or die (mysql_error());
  ...
  <tr>
    <td><img src="banners/<?php echo $row['bimage']; ?>" width="75px" height="50px"></td>
	<td><?php echo $row['bname']; ?></td>

	<td>

	 <a href="deletebanner.php<?php echo '?b_id='.$b_id; ?>"><button type="button" class="btn btn-primary btn-sm">Delete</button></a>

	 <a href="editbanner.php<?php echo '?b_id='.$b_id; ?>"><button type="button" class="btn btn-primary btn-sm">Edit</button></a>
	</td>
  </tr>
  <?php } ?>		
</table>
