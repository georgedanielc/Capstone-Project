...
<body>
    <div id="wrapper">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li><a href="request.php"><i class="fa fa-tasks"></i> Pending Requests</a></li>                    
                        <li class="active"><a href="reservation.php"><i class="fa fa-globe"></i> Pending Reservations</a></li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Pending Reservations</small></h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Reservation Requests</h3>
                        </div>
                        <div class="panel-body">
                            <div id="shieldui-grid1">
								      ...
								      <div class="button-print">
									    <a href="reports/reservationreport.php" target="_blank">
  ...
  <tr>
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-products'];
								$result= mysqli_query($conn,"select * from reservation_request where item_id LIKE '%$txtsearch%' or item_id LIKE '%$txtsearch%'") or die (mysql_error());
			...
			while ($row= mysqli_fetch_array ($result) ){
				$item_id=$row['reservation_id'];
		
			?>
			
			
  <tr>
    <td><img src="pimage/<?php echo $row['image']; ?>" width="75px" height="50px"></td>
	...
	<td>
	 ...
	 <a href="deleteuser.php<?php echo '?username='.$user_id; ?>"><button type="button" class="btn btn-primary btn-sm">Delete</button></a>

	 <a href="edituser.php<?php echo '?username='.$user_id; ?>"><button type="button" class="btn btn-primary btn-sm">Edit</button></a>
	</td>
  </tr>
  		<?php } ?>
</table>
