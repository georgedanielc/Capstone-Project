                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<div class="picture">
							   ...
							   <a href=""><?php if($row['iimage'] != ""): ?>
										<img src="pimage/<?php echo $row['iimage']; ?>" width="200px" height="150px" style="border:4px groove #CCCCCC; border-radius:5px;">
										<?php else: ?>
										<img src="images/book_image.jpg" width="100px" height="100px" style="border:4px groove #CCCCCC; border-radius:5px;">
										<?php endif; ?>
										</a>	
                                    <input type="file" style="height:44px; margin-top:10px;" name="image" id="last-name2" value=<?php echo $row['iimage']; ?>/>
							...
							<div class="products-add-info">
									...
									<label class="control-label .col-lg-2" for="first-name">Item Id
                                    </label>
									 <div class="form-padding-correction">
							         <input type="text" name="item_id" class="form-control" placeholder="Enter Id" value="<?php echo $row['item_id']; ?>">
								    </div>
									</div>
									...
									<label class="control-label .col-lg-2" for="first-name">Name
									 ...
									 <div class="form-padding-correction">
							         <input type="text" name="rname" class="form-control"  placeholder="Enter Name" value="<?php echo $row['rname']; ?>">
								    </div>
									</div>
									...
									<label class="control-label .col-lg-2" for="first-name">Information
									 ...
									 <div class="form-padding-correction">
							         <input type="text" name="itemdesc" class="form-control" placeholder="Enter Information" value="<?php echo $row['itemdesc']; ?>">
								    </div>
									</div>
									
									<div class="form-padding">
									<label class="control-label .col-lg-2" for="first-name">Requirements
                                    </label>
									 <div class="form-padding-correction">
							         <input type="text" name="requirements" class="form-control" placeholder="Enter Information" value="<?php echo $row['requirements']; ?>">
								    </div>
									</div>
									...
									<label class="control-label .col-lg-2" for="first-name">Quantity
									 ...
									 <div class="form-padding-correction">
							         <input type="text" name="quantity" class="form-control"  placeholder="Enter Person" value="<?php echo $row['quantity']; ?>">
								    </div>
							...
							<?php } ?>
						            ...
						            <div class="btn-addproducts">
									 <a href="reservables.php"> <button type="button" class="btn btn-primary">Cancel</button></a>
									</div>
...
mysqli_query($conn,"update items set item_id='$item_id',rname='$rname',itemdesc='$itemdesc',  requirements='$requirements',  quantity='$quantity',iimage='$still_profile1' where item_id='$item_id'")or die(mysql_error());
echo "<script>alert('Successfully Updated Info!'); window.location='reservables.php'</script>";		
...
mysqli_query($conn,"update items set item_id='$item_id',rname='$rname',itemdesc='$itemdesc',  requirements='$requirements',  quantity='$quantity',iimage='$still_profile1' image = '$profile' where item_id='$item_id'")or die(mysql_error());								
echo "<script>alert('Successfully Updated Info!'); window.location='reservables.php'</script>";										
									}
