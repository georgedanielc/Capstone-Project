                        ...
                        <div class="panel-body">
							...
							<div class="products-add-info">
									...
									<label class="control-label .col-lg-2" for="first-name">Name
							         ...
							         <input type="text" name="pname" class="form-control"  placeholder="Enter Name" value="<?php echo $row['pname']; ?>">
								    </div>
									</div>
									...
									<label class="control-label .col-lg-2" for="first-name">Person Involved
									 ...
									 <div class="form-padding-correction">
							         <input type="text" name="person" class="form-control"  placeholder="Enter Person" value="<?php echo $row['person']; ?>">
								    </div>
									...
									<label class="control-label .col-lg-2" for="first-name">Date
									 ...
									 <div class="form-padding-correction">
							         <input type="text" name="date" class="form-control"  placeholder="Enter Date" value="<?php echo $row['date']; ?>">
								    </div>
									</div>
...
mysqli_query($conn,"update projects set pname='$pname',info='$info', person='$person', date='$date', pimage='$still_profile1' where project_id='$project_id'")or die(mysql_error());
echo "<script>alert('Successfully Updated Info!'); window.location='projects.php'</script>";		
...
mysqli_query($conn,"update projects set pname='$pname',info='$info', person='$person', date='$date', pimage='$still_profile1' image='$profile' where project_id='$project_id'")or die(mysql_error());								
echo "<script>alert('Successfully Updated Info!'); window.location='projects.php'</script>";										
									}
