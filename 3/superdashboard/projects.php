...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Ongoing Projects</small></h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Ongoing Projects Information</h3>
                        </div>
                        <div class="panel-body">
                            <div id="shieldui-grid1">
								  ...
								  <a href="addproject.php"><button type="button" class="btn btn-primary">Add Project </button></a>
...
<table>
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from projects where project_id LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
else{
		
											$result= mysqli_query($conn,"select * from projects order by project_id ASC ") or die (mysql_error());
  ...
  <tr>
    <td><img src="projects/<?php echo $row['pimage']; ?>" width="75px" height="50px"></td>
	...
	<td>
	 ...
	 <a href="deleteprojects.php<?php echo '?project_id='.$project_id; ?>"><button type="button" class="btn btn-primary btn-sm">Delete</button></a>

	 <a href="editproject.php<?php echo '?project_id='.$project_id; ?>"><button type="button" class="btn btn-primary btn-sm">Edit</button></a>
	</td>
  </tr>
  		<?php } ?>
</table>
