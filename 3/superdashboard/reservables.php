...
<body>
    <div id="wrapper">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li><a href="request.php"><i class="fa fa-tasks"></i> Pending Requests</a></li>                    
						...
						<li class="active"><a href="reservables.php"><i class="fa fa-globe"></i> Reservables</a></li>
						<li style=" margin-left: 10px;"><p style="color:gray; cursor:context-menu;">____________________________</p></li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Reservables</small></h1>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div id="shieldui-grid1">
								  ...
								  <a href="addreservables.php"><button type="button" class="btn btn-primary">Add Item </button></a>
...
<table>
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from items where item_id LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
else{
		
											$result= mysqli_query($conn,"select * from items order by item_id ASC ") or die (mysql_error());
  ...
  <tr>
    <td><img src="reservables/<?php echo $row['iimage']; ?>" width="75px" height="50px"></td>
	...
	<td>
	 ...
	 <a href="deletereservables.php<?php echo '?item_id='.$item_id; ?>"><button type="button" class="btn btn-primary btn-sm">Delete</button></a>

	 <a href="editreservables.php<?php echo '?item_id='.$item_id; ?>"><button type="button" class="btn btn-primary btn-sm">Edit</button></a>
	</td>
  </tr>
  		<?php } ?>
</table>
