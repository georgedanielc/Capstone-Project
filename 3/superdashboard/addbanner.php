							...
							<form method="POST" enctype="multipart/form-data" action="">
                                   ...
                                   <label>File input</label>
						            ...
						            <div class="btn-addproducts">
									 <a href="banners.php"> <button type="button" class="btn btn-primary">Cancel</button></a>
									</div>
...
$bname = $_POST['bname'];
                    $result=mysqli_query($conn,"select * from banner WHERE bname='$bname' ") or die (mySQL_error());
					...
					{		
						...
						$sql="insert into banner (bname, bimage) values ('$bname','$book_image')";
						if ($conn->query($sql) === TRUE) { 
                   		echo "<script>alert('Banner successfully added!'); window.location='banners.php'</script>";
                        } else {
							echo "<script>alert('Banner sad!'); window.location='addbanner.php'</script>";
                        }
